        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid px-4">
                    <h1 class="mt-4" style="text-align: center; font-weight: bold; font-family: arial;">BARANG MASUK</h1>
...
<div class="modal-dialog">
  <div class="modal-content">
    ...
    <form method="post">
        ...
        <br>
        <br>
        <button type="submit" class="btn btn-primary" name="hapusbarangmasuk">Submit</button>
        </div>
    </form>
